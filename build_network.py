...
net.add_nodes(N=2,  # specifiy the number of cells belong to said group.
              model_name='Scnn1a', location='VisL4', ei='e',  # model_name, location, and ei are optional parameters that help's identifies properties of the cells. The modeler can choose whatever key-value pairs as they deem appropiate.
...
net.add_nodes(N=2, model_name='Rorb', location='VisL4', ei='e',
...
net.add_nodes(N=2, model_name='Nr5a1', location='VisL4', ei='e',
...
net.add_nodes(N=2, model_name='PV1', location='VisL4', ei='i',
...
net.add_nodes(N=2, model_name='PV2', location='VisL4', ei='i',
...
net.add_nodes(N=2, model_name='LIF_exc', location='VisL4', ei='e',
...
net.add_nodes(N=2, model_name='LIF_inh', location='VisL4', ei='i',
...
net.add_edges(source={'ei': 'e'}, target={'model_name': 'PV1'},
              connection_rule=5,
              syn_weight=0.00035,
              # weight_function='wmax',
...
net.add_edges(source={'ei': 'e'}, target={'model_name': 'PV2'},
              connection_rule=5,
              syn_weight=0.00027,
              # weight_function='wmax',
              distance_range=[0.0, 1e+20],
...
net.add_edges(source={'ei': 'e'}, target={'model_name': 'Scnn1a'},
              connection_rule=5,
              syn_weight=6.4e-05,
...
net.add_edges(source={'ei': 'e'}, target={'model_name': 'Rorb'},
              connection_rule=5,
              syn_weight=5.5e-05,
              weight_function='gaussianLL',
              weight_sigma=50.0,
...
net.add_edges(source={'ei': 'e'}, target={'model_name': 'Nr5a1'},
              connection_rule=5,
              syn_weight=7.2e-05,
              weight_function='gaussianLL',
              weight_sigma=50.0,
...
net.build()
net.save(output_dir='toy_network')
...
lgn.add_edges(source=lgn.nodes(), target=net.nodes(model_name='Rorb'),
              iterator='all_to_one',
...
lgn.add_edges(source=lgn.nodes(), target=net.nodes(model_name='Nr5a1'),
              iterator='all_to_one',
              connection_rule=select_source_cells,
              connection_params={'n_syns': 10},
              syn_weight=5e-05,
...
lgn.add_edges(source=lgn.nodes(), target=net.nodes(model_name='Scnn1a'),
              iterator='all_to_one',
              connection_rule=select_source_cells,
              connection_params={'n_syns': 10},
              syn_weight=4e-05,
...
lgn.add_edges(source=lgn.nodes(), target=net.nodes(model_name='PV1'),
              iterator='all_to_one',
              connection_rule=select_source_cells,
              connection_params={'n_syns': 10},
              syn_weight=0.0001,
...
lgn.add_edges(source=lgn.nodes(), target=net.nodes(model_name='PV2'),
              iterator='all_to_one',
              connection_rule=select_source_cells,
              connection_params={'n_syns': 10},
              syn_weight=9e-05,
...
lgn.build()
lgn.save(output_dir='toy_network')


tw = NetworkBuilder("tw")
tw.add_nodes(N=30, model_name='TW', ei='e', location='TW', model_type='virtual')

tw.add_edges(source=tw.nodes(), target=net.nodes(model_name='Rorb'),
             connection_rule=5,
             syn_weight=0.00015,
             # weight_function='wmax',
             distance_range=[30.0, 150.0],
...
tw.add_edges(source=tw.nodes(), target=net.nodes(model_name='Scnn1a'),
             connection_rule=5,
             syn_weight=0.00019,
             # weight_function='wmax',
             distance_range=[30.0, 150.0],
...
tw.add_edges(source=tw.nodes(), target=net.nodes(model_name='Nr5a1'),
             connection_rule=5,
             syn_weight=0.00019,
             # weight_function='wmax',
             distance_range=[30.0, 150.0],
...
tw.add_edges(source=tw.nodes(), target=net.nodes(model_name='PV1'),
             connection_rule=5,
             syn_weight=0.0022,
             # weight_function='wmax',
             distance_range=[0.0, 1.0e+20],
...
tw.add_edges(source=tw.nodes(), target=net.nodes(model_name='PV2'),
             connection_rule = 5,
             syn_weight = 0.0013,
             # weight_function = 'wmax',
             distance_range = [0.0, 1.0e+20],
...
tw.build()
tw.save(output_dir='toy_network')
